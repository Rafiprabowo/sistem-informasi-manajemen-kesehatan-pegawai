...
class MedicalCheckUpController extends Controller
{
    ...
    public function submitAllPemeriksaan(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'pemeriksaanData.*' => 'exists:pemeriksaan_minors,id'
        ]);
        ...
        $uniquePemeriksaanData = array_unique($request->pemeriksaanData);
        ...
        try {
            ...
            foreach ($uniquePemeriksaanData as $pemeriksaanId) {
                DetailPemeriksaan::create([
                    'id_medical_check_up' => $medicalCheckUp->id,
                    'id_pemeriksaan_minor' => $pemeriksaanId,
                    'result' => '' // Adjust according to your application logic
                ]);
            }
