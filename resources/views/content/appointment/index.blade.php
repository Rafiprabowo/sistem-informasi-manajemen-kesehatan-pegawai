                      ...
                      @if($user->doctor->appointments)
                          @foreach($user->doctor->appointments as $index => $appointment)
                              <tr>
                                      ...
                                      <td>
                                        <span class="badge {{$appointment->status === 'pending' ? 'bg-warning':($appointment->status === 'approved' ? 'bg-success' :($appointment->status === 'rejected' ? 'bg-danger':'bg-secondary'))}} me-1"></span> {{$appointment->status}}
                                      </td>
                                      <td class="text-end">
                                        <span class="dropdown">
