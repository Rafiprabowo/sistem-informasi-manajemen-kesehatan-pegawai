                      ...
                      <div class="row row-cards">
                        ...
                        <div class="col-sm-6 col-md-4">
                          <div class="mb-3">
                            ...
                            <input type="text" name="spesialisasi" class="form-control @error('spesialisasi') is-invalid @enderror" placeholder="Spesialisasi" value="{{(isset(auth()->user()->doctor->spesialisasi) ? auth()->user()->doctor->spesialisasi : '')}}">
                            @error('spesialisasi')
                              <div class="invalid-feedback">{{$message}}</div>
                              @enderror
                          </div>
